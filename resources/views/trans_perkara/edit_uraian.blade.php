...
<div class="row">
  <div class="col-sm-12">
    <div class="page-title-box">
      ...
      <h4 class="page-title">Ubah Uraian</h4>
    </div>
  </div>
</div>
        ...
        <div class="row">
          <div class="col-lg-6 col-lg-offset-3">
            <div class="card-box">
             ...
             @endif
             <form action="{{ route('trans_perkara.update_uraian', $detail->id) }}" method="POST" class="form" id="frm-uraian">
              @csrf

              <input type="hidden" name="trans_perkara_id" value="{{ $transaksi->id }}">
              <div class="form-group">
                <label for="" class="control-label">Tanggal</label>
                <input type="date" class="form-control"  value="{{ $detail->tanggal_bayar->toDateString() }}" name="tanggal_bayar">
              </div>
              <div class="form-group">
                ...
                <select name="mst_jenis_transaksi_id" id="" class="form-control">
                  ...
                  <option value="{{ $jenis->id }}"
                    @if ($jenis->id == $detail->mst_jenis_transaksi_id)
                    selected 
                    @endif
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="jumlah_bayar" value="{{ $detail->jumlah_bayar }}">
                </div>
                <div class="form-group">
                  <label for="" class="control-label">Uraian</label>
                  <input type="text" class="form-control" name="uraian" value="{{ $detail->uraian }}">
                </div>
